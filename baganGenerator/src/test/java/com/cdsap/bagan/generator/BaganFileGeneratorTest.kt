...
//        }
//        TestFolder.recursiveDelete(File("tmp"))
//        `when`("Bagan Config File contains Composed Experiment") {
//            File("tmp").mkdir()
//
//            val testLogger = TestLogger()
//            val baganFileGenerator = BaganFileGenerator(
...
//                logger = testLogger,
//                sessionExperiment = "sessionId",
//                bagan = TestBagan.getBaganWithComposedExperiments()
//            )
//            baganFileGenerator.generateExperiments(TestExperiments.getComposedExperiments())
//            then("file value are generated properly for experiment1 with the composed values") {
//                val contentValuesFile = File("tmp/experiment1/templates/podexperiment1.yaml").readText()
//                contentValuesFile should haveSubstring("kscript ExecutionGenerator.kt;")
//
//            }
//        }
//        TestFolder.recursiveDelete(File("tmp"))
